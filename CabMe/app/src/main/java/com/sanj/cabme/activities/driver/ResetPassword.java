...
import static com.sanj.cabme.data.URLs.detailsVerificationUrl;
import static com.sanj.cabme.data.URLs.resetPasswordUrl;
...
public class ResetPassword extends AppCompatActivity {
    ...
    private void updatePassword() {
        android.app.AlertDialog dialogWaiting = new Wrapper().waitingDialog("Resetting Password", mContext);
